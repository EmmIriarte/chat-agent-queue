 -- First, drop existing tables/views/functions if they exist
-- CASCADE will handle all dependencies

-- Drop tables that might have been created incorrectly
DROP TABLE IF EXISTS conversation_messages CASCADE;
DROP VIEW IF EXISTS active_queue CASCADE;
